...
impl ApplicationHandler for DelegatedApp {
    ...
    fn user_event(&mut self, event_loop: &ActiveEventLoop, event: ()) {
        match self {
            DelegatedApp::Uninitialized(app) => app.user_event(event_loop, event),
            DelegatedApp::Initialized(app) => app.user_event(event_loop, event),
        }
    }
    ...
    fn memory_warning(&mut self, event_loop: &ActiveEventLoop) {
        match self {
            DelegatedApp::Uninitialized(app) => app.memory_warning(event_loop),
            DelegatedApp::Initialized(app) => app.memory_warning(event_loop),
        }
    }
}
